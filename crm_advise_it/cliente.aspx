<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="cliente.aspx.vb" Inherits="crm_advise_it.cliente1" MasterPageFile ="~/Site.Master"  %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <div class="container">
        <h1 class="page-title">I Clienti</h1>
			<asp:Panel id="PanelRicercaCliente" runat="server" visible="false" groupingtext="Ricerca">
                <div class="profile-column left">
                        <div class="field">
                            <asp:TextBox ID="txtRicercaCliente" runat="server" CssClass ="input-text" placeholder="Inserisci il cliente"></asp:TextBox>
                            <asp:Button ID="btnRicercaCliente" runat="server" Text="Ricerca" CssClass ="button black" />
                        </div> 
                </div> 
            ...
            <section id="clienti" class="content-section">
            <asp:Panel ID="PanelEliminaCliente" runat="server" visible="false" groupingtext="Vuoi cancellare questo cliente?">
                <div class="profile-column left">
                <br />
                        <div class="field">
            ...
            <section id="profilo-view" class="content-section">
                <form action="#">
                <asp:Panel ID="PanelModificaCliente" runat="server" visible="false">
                    <asp:Label ID="lblIdCliente" runat="server" Text="-1" Visible="false"></asp:Label>
