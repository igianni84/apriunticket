...
#Region "Public Property"
    ...
    Public Property TipoSoglia As String
        Get
            Return _tiposoglia
        End Get
...
#Region "Private Method"
    ...
    Private Sub _load(ByVal _criterio As Integer)
        Dim SQL As String = "SELECT * FROM TipoSoglia WHERE ID=" & _criterio

        Dim DTR As SqlClient.SqlDataReader = Me.Mygest.GetReader(SQL)

        If DTR.Read Then
            Me.ID = DTR("ID")
            Me.TipoSoglia = DTR("tiposoglia")
...
#Region "Public Method"
    ...
    Public Function SalvaData() As Boolean
        ...
        pr.Parameters.AddWithValue("@tiposoglia", Me.TipoSoglia)
        pr.Parameters.AddWithValue("@idazienda", Me.Azienda.ID)
        Dim tb As DataTable = Me.Mygest.GetTab("ITipoSoglia", pr.Parameters)
    ...
    Public Function Delete(ByVal criterio As Integer) As Boolean
        Dim ris As Boolean = False
        Dim SQL As String = "DELETE FROM TipoSoglia WHERE ID=" & criterio
        Try
