...
#Region "Private Method"
    ...
    Private Sub _load(ByVal _criterio As Integer)
        Dim SQL As String = "SELECT * FROM TipoDispositivo WHERE ID=" & _criterio

        Dim DTR As SqlClient.SqlDataReader = Me.Mygest.GetReader(SQL)

        If DTR.Read Then
            Me.ID = DTR("ID")
            Me.TipoDispositivo = DTR("tipodispositivo")
...
#Region "Public Method"
    ...
    Public Function SalvaData() As Boolean
        ...
        pr.Parameters.AddWithValue("@tipodispositivo", Me.TipoDispositivo)
        pr.Parameters.AddWithValue("@idazienda", Me.Azienda.ID)
        Dim tb As DataTable = Me.Mygest.GetTab("ITipoDispositivo", pr.Parameters)
    ...
    Public Function Delete(ByVal criterio As Integer) As Boolean
        Dim ris As Boolean = False
        Dim SQL As String = "DELETE FROM TipoDispositivo WHERE ID=" & criterio
        Try
