...
#Region "Private Method"
    ...
    Private Sub _load(ByVal _criterio As Integer)
        Dim SQL As String = "SELECT * FROM Marchio WHERE ID=" & _criterio
...
#Region "Public Method"
    ...
    Public Function SalvaData() As Boolean
        ...
        pr.Parameters.AddWithValue("@marchio", Me.Marchio)
        pr.Parameters.AddWithValue("@idtipodispositivo", Me.TipoDispositivo.ID)
        Dim tb As DataTable = Me.Mygest.GetTab("IMarchio", pr.Parameters)
    ...
    Public Function Delete(ByVal criterio As Integer) As Boolean
        Dim ris As Boolean = False
        Dim SQL As String = "DELETE FROM Marchio WHERE ID=" & criterio
        Try
