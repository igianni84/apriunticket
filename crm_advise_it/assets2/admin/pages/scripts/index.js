    ...
    return {
        ...
        initMiniCharts: function () {
            ...
            $('.easy-pie-chart .number.bounce').easyPieChart({
             ...
             $('.easy-pie-chart .number.aperto').easyPieChart({
                animate: 1000,
                size: 75,
                lineWidth: 3,
                barColor: Metronic.getBrandColor('red')
             ...
             $('.easy-pie-chart .number.risoperatore').easyPieChart({
                animate: 1000,
                size: 75,
                lineWidth: 3,
             ...
             $('.easy-pie-chart .number.riscliente').easyPieChart({
                animate: 1000,
                size: 75,
                lineWidth: 3,
                barColor: Metronic.getBrandColor('yellow')
             ...
             $('.easy-pie-chart .number.chiuso').easyPieChart({
                animate: 1000,
                size: 75,
                lineWidth: 3,
                barColor: Metronic.getBrandColor('green')
             ...
             $('.easy-pie-chart .number.carico').easyPieChart({
                animate: 1000,
                size: 75,
                lineWidth: 3,
             ...
             $('.easy-pie-chart .number.tutto').easyPieChart({
                animate: 1000,
                size: 75,
                lineWidth: 3,
                barColor: Metronic.getBrandColor('grey')
