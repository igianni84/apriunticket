<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="organizzazione.aspx.vb" Inherits="crm_advise_it.anagrafica" MasterPageFile ="~/Site.Master" MaintainScrollPositionOnPostBack="True" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <div class="container">
        <h1 class="page-title">Le Organizzazioni</h1>
			&nbsp;<asp:Panel id="PanelRicercaOrganizzazioni" runat="server" visible="false" groupingtext="Ricerca">
                <div class="profile-column left">
                        <div class="field">
                            <asp:TextBox ID="txtRicercaOrganizzazioni" runat="server" CssClass ="input-text" placeholder="Inserisci l'organizzazione"></asp:TextBox>
                            <asp:Button ID="btnRicercaOrganizzazioni" runat="server" Text="Ricerca" CssClass ="button black" />
                        </div> 
                </div> 
                                            ...
                                            <thead>
                                                <tr ID="Tr11" runat="server">
                                                    ...
                                                    <%--<th ID="Th2" runat="server" align="center">
                                                        <asp:Label ID="lblIndirizzo1" runat="server" Text="Indirizzo" Width="30%"></asp:Label>
                                                    </th>--%>
                                    ...
                                    <ItemTemplate>
                                        <tbody>
                                            <tr>
                                                ...
                                                <%--<td>
                                                    <asp:Label ID="lblIndirizzo1" runat="server" Text='<%# Eval("indirizzo")%>'></asp:Label>
                                                </td>--%>
                                                <td>
                                                ...
                                                <td>
                                                    <asp:Label ID="lblComune" runat="server" Text='<%# Eval("idcomune")%>'></asp:Label>
                                                </td>
                                                <td>
            ...
            <section id="profilo-view" class="content-section">
                ...
                <asp:Panel ID="PanelModificaOrganizzazione" runat="server" visible="false">
                    <asp:Label ID="lblIdAzienda" runat="server" Text="-1" Visible="false"></asp:Label>
                    <asp:Label ID="lblIdRecapito" runat="server" Text="-1" Visible="false"></asp:Label>
                    <asp:Image ID="imgLogo" runat="server" Height ="10%" Width="30%"></asp:Image>
                    <br />
                    <div class="profile-column left">
                        <div class="field">
                    ...
                    <div class="profile-column right">
                        ...
                        <div class="field">
                            ...
                            <asp:DropDownList ID="ddlRegione" runat="server" class="input-drop" style="width:220px; margin-bottom:14px; height:27px"                                
