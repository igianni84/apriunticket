<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="fornitoreclie.aspx.vb" Inherits="crm_advise_it.forncliente" MasterPageFile ="~/Site.Master" MaintainScrollPositionOnPostBack="True" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
   ...
   <%-- <asp:UpdatePanel ID="UpdatePanel1" runat="server">
    ...
    <div>
     ...
     <div class="container">
        <h1 class="page-title">I Fornitori Clienti</h1>
                                                ...
                                                <%If Session("tipoutente") = "Utente" Then%>
                                                 <td class ="dimtdim ">
                                                    <asp:ImageButton ID="imgMostra" runat="server" 
                                                        ImageUrl="~/images/lente.png" ToolTip="Vedi" AlternateText ='<%# eval("id") %>' CssClass ="dimim "/>
                                                </td> 
                                                <%Else%>                                     
                                                <td class ="dimtdim ">
                ...
                <asp:Panel ID="PanelModificaFornitore" runat="server" visible="false">
                    ...
                    <div class="profile-column right">
                        ...
                        <div class="field">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator4" ControlToValidate="txtIndirizzo" 
                                        Display="Dynamic" EnableClientScript="False" runat="server"  
                                        ErrorMessage="*" ForeColor ="Red" ></asp:RequiredFieldValidator>
                        </div> 
                        <div class="field">
