<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="operatore.aspx.vb" Inherits="crm_advise_it.operatore" MasterPageFile ="~/Site.Master" MaintainScrollPositionOnPostBack="True" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <ContentTemplate>
     ...
     <div class="container">
        <h1 class="page-title">Gli Operatori</h1>
			<asp:Panel id="PanelRicercaOperatore" runat="server" visible="false" groupingtext="Ricerca">
                <div class="profile-column left">
                        <div class="field">
                            <asp:TextBox ID="txtRicercaOperatore" runat="server" CssClass ="input-text" placeholder="Inserisci l'operatore"></asp:TextBox>
                            <asp:Button ID="btnRicercaOperatore" runat="server" Text="Ricerca" CssClass ="button black" />
                        </div> 
                </div> 
            ...
            <section id="operatore" class="content-section">
            <asp:Panel ID="PanelEliminaOper" runat="server" visible="false" groupingtext="Vuoi cancellare quest' operatore?">
                <div class="profile-column left">
                <br />
                        <div class="field2" >
                                            ...
                                            <thead>
                                                <tr ID="Tr11" runat="server" >
                                                    ...
                                                    <th ID="Th2" runat="server" align="center">
                                                        <asp:Label ID="lblOrganizzazione1" runat="server" Text="Organizzazione"></asp:Label>
                                                    </th>                                               
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                 ...
                                                 <td>
                                                    <asp:Label ID="lblOrganizzazione1" runat="server" Text='<%# Eval("descrizione")%>'></asp:Label>
                                                </td>                                           
                                                <td class ="dimtdim" >
            ...
            <section id="profilo-view" class="content-section">
                ...
                <asp:Panel ID="PanelModificaUtente" runat="server" visible="false">
                    ...
                    <div class="profile-column right">
                        ...
                        <br />
                        <div class="field">
                            <asp:Label ID="lblOrganizzazione" runat="server" CssClass="label " text="Organizzazione"></asp:Label>
                        ...
                        <div class="field">
                            ...
                            <asp:DropDownList ID="ddlSubOrganizzazione" runat="server" class="input-drop" 
                                style="width:220px;margin-bottom:14px;height:27px" AutoPostBack="True"
                                ></asp:DropDownList>
                        </div>
                        <div class="field">
                            <asp:Label ID="lblCliente" runat="server" CssClass="label " Text="Cliente" Visible="false"></asp:Label>
                            <asp:DropDownList ID="ddlCliente" runat="server" class="input-drop" style="width:220px; margin-bottom:14px; height:27px" Visible="false"></asp:DropDownList>
                        ...
                        <div class="field">
                            <asp:Label ID="lblSubCliente" runat="server" CssClass="label " Text="SubCliente" Visible="false" ></asp:Label>
                            <asp:DropDownList ID="ddlSubCliente" runat="server" class="input-drop" style="width:220px; margin-bottom:14px; height:27px" Visible="false"></asp:DropDownList>
            ...
            <div>
            <div class="button-area"> 
                    <asp:LinkButton ID="lbModifica" runat="server" Text="Modifica Password"  CssClass ="order-status blu" Visible="false" ></asp:LinkButton>
            </div>
            <asp:Panel ID="PanelModificaPwd" runat="server" Visible="false" >
                        ...
                        <asp:ListView ID="ListView2" runat="server">
                                    ...
                                    <ItemTemplate>
                                        <tbody>
                                            <tr>
                                                <td class="a-left">
                                                    <asp:Label ID="blDescrizione" runat="server" Text='<%# Eval("descrizione")%>'></asp:Label>
                                                </td>  
                                                <td >
